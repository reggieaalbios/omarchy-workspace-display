...
// value. Stock panels expose the same cursor-active/index relationship.
  ...
  Column {
    ...
    BorderSurface {
      ...
      Popup {
        ...
        onClosed: root.cursorActive = false
        ...
        contentItem: ListView {
          ...
          delegate: BorderSurface {
            ...
            readonly property bool hasCursor: root.cursorActive && index === optionList.currentIndex
            ...
            color: hasCursor
              ...
              : (isSelected ? Util.alpha(root.accent, 0.08) : "transparent")
            borderSpec: Border.controlSpec(hasCursor ? "focus" : "normal", root.foreground, root.accent)
            ...
            Rectangle {
              ...
              width: Math.max(Style.normalBorderWidth, Style.spacing.hairline)
              radius: width
            ...
            Text {
              ...
              anchors.verticalCenter: parent.verticalCenter
              anchors.leftMargin: optionRow.borderLeft + Style.spacing.controlPaddingX
              anchors.rightMargin: Style.spacing.md
              text: root.optionLabel(modelData)
              color: optionRow.hasCursor ? Style.hoverStateColor(root.foreground, root.accent) : root.foreground
              font.family: root.fontFamily
              font.pixelSize: Style.font.body
              elide: Text.ElideRight
            }
            ...
            Text {
              ...
              anchors.right: parent.right
              anchors.verticalCenter: parent.verticalCenter
              anchors.rightMargin: optionRow.borderRight + Style.spacing.controlPaddingX
              visible: parent.isSelected
              text: "󰄬"
              color: parent.hasCursor ? Style.hoverStateColor(root.foreground, root.accent) : root.accent
              font.family: root.fontFamily
              font.pixelSize: Style.font.body
            }
